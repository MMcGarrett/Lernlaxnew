...
export default function ChallengesSection() {
  return (
    <section id="challenges" className="bg-[#2F403D] text-white px-6 py-8 md:py-20">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-10">Herausforderungen – die alltäglichen Probleme</h2>
