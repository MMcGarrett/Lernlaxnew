  ...
  return (
    <main className="relative min-h-screen bg-[#1c1f20] text-white">
      <ScrollEffect>
        ...
        <Hero />
        <ChallengesSection />
        <CharacterSelection onCharacterSelect={(name) => setSelectedCharacter(name)} />
        
        {/* Dein Weg - START*/}
        <div id="deinWeg" className="h-48 -mt-48 invisible" /> {/* Marker für Navbar*/}
        <section>
          {/* Dein Weg - Schlaf */}
          <SectionModule
